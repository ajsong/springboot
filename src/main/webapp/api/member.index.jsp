...
<div class="navBar navBar-hidden">
	<a class="left sign" href="/wap/member/sign"><i class="member-sign"></i></a>
	<div class="titleView-x">会员</div>
	<a class="right" href="/wap/member/set"><i class="member-set"></i></a>
</div>
...
<div class="member-index main-bottom width-wrap">
	<div class="topView">
		<div class="infoView">
			...
			<div class="btnView">
				<a href="/wap/login">登录</a>
				<a href="/wap/register">注册</a>
			</div>
			</c:if>
		</div>
		<div class="moneyView">
			<a href="/wap/member/money"><div><i></i><span>我的余额<small><c:if test="${member_id>0}"><fmt:formatNumber type="number" value="${member.money}" pattern="0.00"/></c:if><c:if test="${member_id==0}">0.00</c:if></small></span></div></a>
			<c:if test="${edition>2}">
			<a class="ge-left" href="/wap/member/commission"><div><i class="commission"></i><span>我的佣金<small><c:if test="${member_id>0}"><fmt:formatNumber type="number" value="${member.commission}" pattern="0.00"/></c:if><c:if test="${member_id==0}">0.00</c:if></small></span></div></a>
			</c:if>
		</div>
	</div>
	...
	<section>
		<ul class="tableView tableView-light">
			<li><a href="/wap/order"><h1><big>全部订单</big><em class="ico1"></em>我的订单</h1></a></li>
			<li class="orderList">
				<a class="ico1 badge" href="/wap/order/index?status=0"><div><sub></sub></div></a>
				<a class="ico2 badge" href="/wap/order/index?status=1"><div><sub></sub></div></a>
				<a class="ico3 badge" href="/wap/order/index?status=2"><div><sub></sub></div></a>
				<a class="ico4 badge" href="/wap/order/index?status=3"><div><sub></sub></div></a>
			</li>
		</ul>

		<%if(Arrays.asList((String[])request.getAttribute("function")).contains("shop")){%>
		<ul class="tableView tableView-light ge-top ge-light">
			<li><a href="/wap/member/business"><h1><em class="ico12"></em>我是商家</h1></a></li>
		</ul>
		<%}%>
		...
		<ul class="tableView tableView-light ge-top ge-light">
			...
			<li><a href="/wap/member/integral"><h1><em class="ico3"></em>我的积分</h1></a></li>
			<li><a href="/wap/goods/index?integral=1"><h1><em class="ico5"></em>积分商城</h1></a></li>
			<li><a href="/wap/order/index?integral_order=1"><h1><em class="ico2"></em>积分商城订单</h1></a></li>
			<%}%>
		</ul>
		</c:if>
		...
		<ul class="tableView tableView-light ge-top ge-light">
			...
			<li><a href="/wap/coupon/index?status=1"><h1><c:if test="${coupon_count>0}"><big>${coupon_count}张</big></c:if><em class="ico4"></em>我的优惠券</h1></a></li>
			<%}%>
			<c:if test="${edition>2}"><li><a href="/member/code"><h1><em class="ico7"></em>分享赚佣金</h1></a></li></c:if>
			<li><a href="/wap/message/index"><h1><em class="ico8"></em>我的消息</h1></a></li>
			<li><a href="/wap/favorite/index?type_id=1"><h1><em class="ico9"></em>我的收藏</h1></a></li>
			<li><a href="/wap/member/goods_history"><h1><em class="ico10"></em>足迹</h1></a></li>
		</ul>

		<ul class="tableView tableView-light ge-top ge-light">
			<li><a href="/wap/member/set"><h1><em class="ico11"></em>设置</h1></a></li>
		</ul>
	</section>
</div>
